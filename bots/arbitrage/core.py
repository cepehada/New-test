...
class ArbitrageCore:
    ...
    async def verify_opportunity(
        ...
        try:
            ...
            buy_ticker = await fetch_ticker(opportunity.buy_exchange, opportunity.symbol)
            sell_ticker = await fetch_ticker(opportunity.sell_exchange, opportunity.symbol)
            ...
            logger.debug(
                "Возможность больше не выгодна: %s - "
                "прибыль: %.2f%%",
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        if stats["opportunities_verified"] > 0:
            stats["execution_ratio"] = stats["opportunities_executed"] / stats["opportunities_verified"]
        else:
