...
def setup_logging(log_level=None, log_file=None, console_format=None, file_format=None):
    """
    ...
    try:
        ...
        console_format = (
            console_format or "%(asctime)s [%(levelname)s] %(name)s: %(message)s"
        )
        file_format = (
            file_format
    ...
    logger.info(
        "Логирование настроено. Уровень: %s, Файл логов: %s",
        log_level,
        log_file or "не задан",
    )
